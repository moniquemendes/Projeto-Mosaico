        ...
        <article>
            ...
            <h6>Inovação</h6><hr class="linhaHr">
                ...
                <div class="col-xs-12 col-sm-12 col-md-offset4">            
                    <img class="MoImgInovacao" src="imagens/imgBusiness/imgInovacao.jpg" alt="Inovacao" />
                </div>
         ...
         <div class="container">
            <h6>Idéias</h6><hr class="linhaHr">
                <h2><b>Armazenar dados em forma de DNA é a chave para preservá-los pela eternidade</b></h2>
                 <div class="col-xs-12 col-sm-12 col-md-offset4"> 
                    <img class="MoImgInovacao" src="imagens/imgBusiness/imBInovacao.jpg" alt="Inovacao" />
             </div>  
