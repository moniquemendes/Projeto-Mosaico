...
<body>
    ...
    ?>
        ...
        <article>
            <div class="container">
            <h6>Negócios</h6>
                <img class="imgSebrae" src="imagens/imgBusiness/sebrae.gif" alt="Sebrae" /><hr class="linhaHr">
                
                <h2><b>Profissional de TI precisa entender de negócio?</b></h2>
                
                <div class="col-xs-12 col-sm-12 col-md-offset4">
						<img class="MoImgNegocios" src="imagens/imgBusiness/imgNegocios.jpg" alt="Negocios" />			
					</div> <!-- Classe da imagem -->
        ...
        <div class="container">
              <h6>Idéias de Negócios</h6><hr class="linhaHr">   
              <p align="justify">Nullam interdum dapibus urna, ac tristique tortor dignissim id. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum condimentum augue mauris, sed rhoncus velit iaculis vitae. Ut placerat, metus nec convallis dapibus, velit tellus scelerisque sapien, nec ullamcorper neque enim nec mauris. Integer ac tortor magna. Vestibulum viverra nulla ut massa volutpat hendrerit.Proin a dignissim diam, ut blandit ante</p> 
            </div>
            <div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-4">
								<a href="http://www.sebrae.com.br"><img class="imgPropaganda" src="imagens/imgBusiness/imgNegociosSebrae.jpg" alt="Negocios" /></a>
          	
					</div> <!-- fim div Sebrae -->
                    
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <a href="http://www.endeavor.org.br"><img class="imgPropaganda" src="imagens/imgBusiness/imgNegociosEndeavor.jpg" alt="Negocios"/></a>
          		
					</div> <!-- fim div endeavor -->
                    
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <a href="http://revistapegn.globo.com"><img class="imgPropaganda" src="imagens/imgBusiness/imgNegociosPQGN.jpg" alt="Negocios" /></a>
